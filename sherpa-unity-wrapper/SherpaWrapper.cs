...
namespace SherpaUnityWrapper
{
    ...
    {
        public static readonly string DEBUG_NAME = "SHERPA_UNITY_WRAPPER_DEBUG";

        private readonly string UNITY_PLAYER_CLASS_NAME = "com.unity3d.player.UnityPlayer";
        private readonly string SHERPA_ONNX_PLUGIN_JAVA_CLASS_NAME = "com.k2fsa.sherpa.onnx.SherpaOnnxPlugin";
        ...
        /// <summary>
        /// Basic SherpaWrapper constructor
        /// </summary>
        /// <remarks>
        /// Just for creating an object.
        /// </remarks>
        public SherpaWrapper()
        {
            Debug.Log($"{DEBUG_NAME}: SherpaWrapper constructor called.");
        }
